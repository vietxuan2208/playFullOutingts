...
<p class="text-[#111811] dark:text-white text-4xl font-black leading-tight tracking-[-0.033em]">Forgot Password?</p>
<p class="text-[#618961] dark:text-gray-300 text-base font-normal leading-normal">No worries! Enter your email and we'll send you a verification code.</p>
</div>
</div>
...
<span class="truncate">Send Verification Code</span>
</button>
</form>
</div>
<div class="mt-8 text-center">
<p class="text-[#618961] dark:text-gray-300 text-sm">
                    Remember your password? <a class="font-bold text-primary hover:underline" href="{{ route('login') }}">Back to Login.</a>
</p>
</div>
</div>
</div>
