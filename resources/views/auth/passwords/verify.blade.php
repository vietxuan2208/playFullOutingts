...
<p class="text-[#111811] dark:text-white text-4xl font-black leading-tight tracking-[-0.033em]">Check Email</p>
<p class="text-[#618961] dark:text-gray-300 text-base font-normal leading-normal">We've sent a 6-digit verification code. Please enter it below.</p>
</div>
</div>
...
<p class="text-[#111811] dark:text-white text-base font-medium leading-normal pb-2">Verification Code</p>
...
<p class="text-[#618961] dark:text-gray-300 text-sm">
                    Didn't receive the code? <a class="font-bold text-primary hover:underline" href="{{ route('password.request') }}">Resend code</a>
</p>
<p class="text-[#618961] dark:text-gray-300 text-sm">
                    Or <a class="font-bold text-primary hover:underline" href="{{ route('login') }}">back to Login.</a>
</p>
</div>
</div>
</div>
